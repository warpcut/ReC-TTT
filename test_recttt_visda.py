...
import torch
from dataset import get_data_transforms_test, get_data_transforms, get_visda_transforms
import numpy as np
import random
import os
...
import argparse
from utils import evaluation_ttt2_semi
import warnings
import copy
import logging
...
def test(args):
    ...
    train_data, val_split_data, test_data, val_data = VISDA(data_root, data_transform, data_test_transform, 111)
    ...
    if 'wide' in args.save_name:
        ...
        encoder, bn = resnet50(pretrained=False, custom=False)
...
if __name__ == '__main__':
    ...
    done = ['']#['gaussian_noise', 'shot_noise', 'impulse_noise', 'defocus_blur','brightness', 'contrast', 'elastic_transform']
    result_list_best = []
